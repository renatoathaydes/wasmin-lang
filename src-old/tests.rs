...
fn test_global_get_type() {
    assert_eq!(
        Expression::Global("1".to_owned(), I32).get_type(),
        vec![I32]
    );
    assert_eq!(
        Expression::Global("1".to_owned(), I64).get_type(),
        vec![I64]
    );
}
...
fn test_let_get_type() {
    assert_eq!(
        Expression::Let((
            vec!["a".to_owned()],
            Box::new(expr_group!(expr_const!("1" I32))),
            vec![None]
        ))
            .get_type(),
        vec![]
    ...
    assert_eq!(
        Expression::Let((
            ...
            Box::new(expr_group!(expr_const!("1" I32) expr_const!("1" I32))),
            vec![Some(I64), None]
        ))
            .get_type(),
        vec![]
...
fn test_group_get_type() {
    ...
    assert_eq!(
        Expression::Group(vec![expr_const!("1" I32)]).get_type(),
        vec![I32]
    );
    assert_eq!(
        Expression::Group(vec![expr_const!("1" F64)]).get_type(),
        vec![F64]
    );
    assert_eq!(
        Expression::Group(vec![expr_const!("1" I32), expr_const!("1" F64)]).get_type(),
        vec![I32, F64]
    );
}
...
fn test_group_multi_get_type() {
    assert_eq!(
        Expression::Group(vec![expr_group!(expr_const!("1" I32) expr_const!("1" F64))]).get_type(),
        vec![I32, F64]
    );
    assert_eq!(
...
fn test_error_get_type() {
    let err = werr_syntax!("wrong", (10, 20));
    assert_eq!(
        Expression::ExprError(err.clone()).get_type(),
        vec![Error(err)]
    )
}
...
fn test_group_with_break_get_type() {
    assert_eq!(
        expr_group!(expr_const!("1" I32) expr_break!(I32)).get_type(),
        vec![]
    );
    assert_eq!(
        expr_group!(expr_const!("1" I32)
                           expr_const!("2" I32)
                           expr_break!(I32 I32))
            .get_type(),
        vec![]
...
fn test_loop_get_type() {
    ...
    assert_eq!(
        expr_loop!(expr_group!(expr_const!("1" I32)
                                      expr_const!("2" I32)
                                      expr_break!(I32 I32)))
            .get_type(),
        vec![I32, I32]
    ...
    assert_eq!(
        expr_loop!(expr_group!(expr_if!(expr_const!("1" I32);
